    ...
    resources: {
        en: {
            local: {
                ...
                EncryptionKeyWait: 'Waiting for encryption key...',
                QuizPoll: 'Quiz',
                Translate: 'Translate',
                ...
                CopyMessageLink: 'Copy Link',
                ShowInChat: 'Show in Chat',
                ReplyInPrivate: 'Reply in Private',
                ChatInfo: 'Chat Info',
        ...
        ru: {
            local: {
                ...
                EncryptionKeyWait: 'Ожидание ключа шифрования...',
                QuizPoll: 'Викторина',
                Translate: 'Перевести',
                ...
                CopyMessageLink: 'Копировать ссылку',
                ShowInChat: 'Показать в чате',
                ReplyInPrivate: 'Ответить в личке',
