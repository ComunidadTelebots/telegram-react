...
- **Selector rapido de diseno adaptativo**: el control inferior izquierdo ahora usa los tokens del diseno activo, muestra las versiones Android `v16` a `v13` como opciones independientes y actualiza etiqueta, color, radios y superficie al cambiar entre Web, Desktop, Android, iOS, macOS, Unigram y Aurora. Archivos: `src/Components/DesignSwitcher.js`, `src/Components/DesignSwitcher.css`, `src/Components/MainPage.js`, `src/Design.js`.
