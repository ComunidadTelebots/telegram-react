...
- **Variantes Android**: el selector de apariencia ahora separa Android en cuatro versiones: `Android 7.x` clásico, `Android 12.5` pre-redesign, `Android 12.6` redesign y `Android Beta 12.6.4` Glass. Cada variante comparte la base Android y ajusta radios, fondos, burbujas, sidebar, headers, composer y modo dark. Archivos: `src/Design.js`, `src/Theme.js`, `src/Components/ColumnLeft/ThemePicker.js`, `src/designs/android.css`.
